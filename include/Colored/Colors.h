...
namespace unfoldtacpn {
    namespace Colored {
        ...
        public:
            static const ColorType* starColorType() {
                static StarColorType _instance;

                return &_instance;
            }

            StarColorType(StarColorType const&) = delete;
            void operator=(StarColorType const&) = delete;

            bool operator== (const StarColorType& other) {
                return true;
            }
        };
