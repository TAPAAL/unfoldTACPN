...
public:
    ...
    using MarkingAgeMap = std::unordered_map<std::string, std::vector<std::int>>; //TODO: find good storage representation
...
private:
    ...
    MarkingAgeMap parseInitialMarkingAges(rapidxml::xml_node<>* element);
